...
<style lang="scss">
.banner {
    background-image: linear-gradient(to bottom, #318cff, #ac79ea, #e765c1, #ff608f, #ff715f, #f06e4e, #e06b3d, #cf692d, #a04833, #6c2e2d, #381b1f, #000000);    margin-bottom: 200px;
    height: 300vh;
    .sun {
        position: absolute;
        top: 150px;
